function calculateGrade() {
    ...
    if (!isNaN(earnedPoints) && !isNaN(maxPoints) && maxPoints !== 0) {
        ...
        document.getElementById("showGrade").innerHTML = `Your grade is: ${grade.toFixed(2)}`;
    } else {
...
function calculateGradeInDecrease() {
    ...
    if (increase > 0) {
        ...
        document.getElementById("showIncrease").innerHTML = `It got increased by: <span style="font-weight: bold;">${percentageIncrease}%</span>`;
    } else if (increase < 0) {
        ...
        document.getElementById("showIncrease").innerHTML = `It got decreased by: <span style="font-weight: bold;">${percentageIncrease}%</span>`;
    } else {
